...
export function ChartProjects({ projects }: { projects: Project[] }) {
  ...
  const { chartData, stats } = UseChartData(projects, "createdAt", timeRange);
      ...
      <CardHeader>
        ...
        <CardDescription className="flex flex-col gap-1">
          <span className="hidden @[540px]/card:block">
            Total: {stats.total} projects | New in period: {stats.new} projects
          </span>
